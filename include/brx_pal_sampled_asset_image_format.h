...
enum BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT
{
    ...
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_R8G8B8A8_UNORM = 1,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_R8G8B8A8_SRGB = 2,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_R16G16B16A16_SFLOAT = 3,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_BC7_UNORM_BLOCK = 4,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_BC7_SRGB_BLOCK = 5,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_UNORM_BLOCK = 6,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_SRGB_BLOCK = 7
};

...
enum BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT
{
    ...
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_BC7_UNORM_BLOCK = 3,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_BC7_SRGB_BLOCK = 4,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_UNORM_BLOCK = 5,
    BRX_PAL_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_SRGB_BLOCK = 6
};

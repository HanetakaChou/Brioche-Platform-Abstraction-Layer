...
void brx_pal_d3d12_descriptor_set_layout::init(uint32_t descriptor_set_binding_count, BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING const *wrapped_descriptor_set_bindings)
{
	...
	for (uint32_t binding_index = 0U; binding_index < descriptor_set_binding_count; ++binding_index)
	{
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_DYNAMIC_UNIFORM_BUFFER;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_STORAGE_BUFFER;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
			this->m_descriptor_layouts[binding_index].root_descriptor_table_num_descriptors = wrapped_descriptor_set_bindings[binding_index].descriptor_count;
		}
		break;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_SAMPLED_IMAGE;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
			this->m_descriptor_layouts[binding_index].root_descriptor_table_num_descriptors = wrapped_descriptor_set_bindings[binding_index].descriptor_count;
		}
		break;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_SAMPLER;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
			this->m_descriptor_layouts[binding_index].root_descriptor_table_num_descriptors = wrapped_descriptor_set_bindings[binding_index].descriptor_count;
		}
		break;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_STORAGE_IMAGE;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
			this->m_descriptor_layouts[binding_index].root_descriptor_table_num_descriptors = wrapped_descriptor_set_bindings[binding_index].descriptor_count;
		}
		break;
		...
		{
			this->m_descriptor_layouts[binding_index].root_parameter_type = BRX_PAL_DESCRIPTOR_TYPE_TOP_LEVEL_ACCELERATION_STRUCTURE;
			this->m_descriptor_layouts[binding_index].root_parameter_shader_register = wrapped_descriptor_set_bindings[binding_index].binding;
			this->m_descriptor_layouts[binding_index].root_descriptor_table_num_descriptors = wrapped_descriptor_set_bindings[binding_index].descriptor_count;
		}
		break;
		...
		{
			assert(false);
			this->m_descriptor_layouts[binding_index].root_parameter_type = static_cast<BRX_PAL_DESCRIPTOR_TYPE>(-1);
		}
		}
	}
}
	...
	for (uint32_t set_index = 0U; set_index < descriptor_set_layout_count; ++set_index)
	{
		...
		for (uint32_t binding_index = 0U; binding_index < binding_count; ++binding_index)
		{
			...
			case BRX_PAL_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
			{
				...
				if (BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != descriptor_layouts[binding_index].root_descriptor_table_num_descriptors)
				{
			...
			case BRX_PAL_DESCRIPTOR_TYPE_STORAGE_BUFFER:
			{
				...
				assert(BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != descriptor_layouts[binding_index].root_descriptor_table_num_descriptors);
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].NumDescriptors = descriptor_layouts[binding_index].root_descriptor_table_num_descriptors;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].BaseShaderRegister = descriptor_layouts[binding_index].root_parameter_shader_register;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].RegisterSpace = set_index;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].OffsetInDescriptorsFromTableStart = 0U;
...
void brx_pal_d3d12_descriptor_set::init(brx_pal_d3d12_descriptor_allocator *descriptor_allocator, brx_pal_descriptor_set_layout const *wrapped_descriptor_set_layout, uint32_t unbounded_descriptor_count)
{
	...
	for (uint32_t descriptor_layout_index = 0U; descriptor_layout_index < descriptor_layout_count; ++descriptor_layout_index)
	{
		...
		brx_pal_d3d12_descriptor &new_descriptor = this->m_descriptors[descriptor_layout_index];
		...
		case BRX_PAL_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
		{
			new_descriptor.root_parameter_type = unwrapped_descriptor_layout.root_parameter_type;
			new_descriptor.root_parameter_shader_register = unwrapped_descriptor_layout.root_parameter_shader_register;
			if (BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != unwrapped_descriptor_layout.root_descriptor_table_num_descriptors)
			{
		...
		case BRX_PAL_DESCRIPTOR_TYPE_STORAGE_BUFFER:
		{
			new_descriptor.root_parameter_type = unwrapped_descriptor_layout.root_parameter_type;
			new_descriptor.root_parameter_shader_register = unwrapped_descriptor_layout.root_parameter_shader_register;
			assert(BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != unwrapped_descriptor_layout.root_descriptor_table_num_descriptors);
			new_descriptor.root_descriptor_table.num_descriptors = unwrapped_descriptor_layout.root_descriptor_table_num_descriptors;
			new_descriptor.root_descriptor_table.base_descriptor_heap_index = descriptor_allocator->alloc_cbv_srv_uav_descriptor(new_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		...
		{
			assert(false);
			new_descriptor.root_parameter_type = static_cast<BRX_PAL_DESCRIPTOR_TYPE>(-1);
		}
		}
	}
}
...
{
	for (brx_pal_d3d12_descriptor const &delete_descriptor : this->m_descriptors)
	{
...
void brx_pal_d3d12_descriptor_set::write_descriptor(ID3D12Device *device, brx_pal_d3d12_descriptor_allocator const *descriptor_allocator, uint32_t dst_binding, BRX_PAL_DESCRIPTOR_TYPE wrapped_descriptor_type, uint32_t dst_descriptor_start_index, uint32_t src_descriptor_count, brx_pal_uniform_upload_buffer const *const *src_dynamic_uniform_buffers, uint32_t const *src_dynamic_uniform_buffer_ranges, brx_pal_read_only_storage_buffer const *const *src_read_only_storage_buffers, brx_pal_storage_buffer const *const *src_storage_buffers, brx_pal_sampled_image const *const *src_sampled_images, brx_pal_storage_image const *const *src_storage_images, brx_pal_sampler const *const *src_samplers, brx_pal_top_level_acceleration_structure const *const *src_top_level_acceleration_structures)
{
	...
	brx_pal_d3d12_descriptor &destination_descriptor = this->m_descriptors[destination_descriptor_layout_index];
	...
	case BRX_PAL_DESCRIPTOR_TYPE_DYNAMIC_UNIFORM_BUFFER:
	{
		...
		destination_descriptor.root_constant_buffer_view.address_base = static_cast<brx_pal_d3d12_uniform_upload_buffer const *>(src_dynamic_uniform_buffers[0])->get_resource()->GetGPUVirtualAddress();
	}
	break;
	case BRX_PAL_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
	{
	...
	case BRX_PAL_DESCRIPTOR_TYPE_STORAGE_BUFFER:
	{
		...
		for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
		{
			...
			D3D12_UNORDERED_ACCESS_VIEW_DESC unordered_access_view_desc = (*static_cast<brx_pal_d3d12_storage_buffer const *>(src_storage_buffers[descriptor_index])->get_unordered_access_view_desc());
...
uint32_t brx_pal_d3d12_descriptor_set::get_descriptor_count() const
{
	return static_cast<uint32_t>(this->m_descriptors.size());
}

brx_pal_d3d12_descriptor const *brx_pal_d3d12_descriptor_set::get_descriptors() const
{

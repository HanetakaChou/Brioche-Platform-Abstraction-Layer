...
brx_pal_d3d12_render_pass::brx_pal_d3d12_render_pass(
...
{
	BRX_PAL_COLOR_ATTACHMENT_IMAGE_FORMAT const *color_attachment_formats;
...
uint32_t brx_pal_d3d12_render_pass::get_color_attachments_clear_count() const
{
	return static_cast<uint32_t>(this->m_color_attachment_clear_indices.size());
}

uint32_t const *brx_pal_d3d12_render_pass::get_color_attachment_clear_indices() const
{
...
uint32_t brx_pal_d3d12_render_pass::get_color_attachment_flush_for_sampled_image_count() const
{
	return static_cast<uint32_t>(this->m_color_attachment_flush_for_sampled_image_indices.size());
}

uint32_t const *brx_pal_d3d12_render_pass::get_color_attachment_flush_for_sampled_image_indices() const
{
...
uint32_t brx_pal_d3d12_render_pass::get_color_attachment_flush_for_present_count() const
{
	return static_cast<uint32_t>(this->m_color_attachment_flush_for_present_indices.size());
}

uint32_t const *brx_pal_d3d12_render_pass::get_color_attachment_flush_for_present_indices() const
{
...
BRX_PAL_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT const *brx_pal_d3d12_render_pass::get_depth_stencil_attachment_format() const
{
	BRX_PAL_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT const *depth_stencil_attachment_format;
...
bool brx_pal_d3d12_render_pass::get_depth_stencil_attachment_clear() const
{
	return this->m_depth_stencil_attachment_clear;
}

bool brx_pal_d3d12_render_pass::get_depth_stencil_attachment_flush_for_sampled_image() const
{

...
void brx_pal_d3d12_graphics_command_buffer::bind_graphics_descriptor_sets(brx_pal_pipeline_layout const *wrapped_pipeline_layout, uint32_t descriptor_set_count, brx_pal_descriptor_set const *const *wrapped_descriptor_sets, uint32_t dynamic_offet_count, uint32_t const *dynamic_offsets)
{
    ...
    ID3D12RootSignature *root_signature = static_cast<brx_pal_d3d12_pipeline_layout const *>(wrapped_pipeline_layout)->get_root_signature();
    ...
    for (uint32_t set_index = 0U; set_index < descriptor_set_count; ++set_index)
    {
        ...
        uint32_t const binding_count = static_cast<brx_pal_d3d12_descriptor_set const *>(wrapped_descriptor_sets[set_index])->get_descriptor_count();
        brx_pal_d3d12_descriptor const *descriptors = static_cast<brx_pal_d3d12_descriptor_set const *>(wrapped_descriptor_sets[set_index])->get_descriptors();
